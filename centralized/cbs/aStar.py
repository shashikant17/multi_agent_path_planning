...
if __name__=='__main__':
    ...
    # m.tracePath({a:aPath},kill=True,delay=3000)
    # m.tracePath({b:m.path},kill=True,delay=3000)
    # # m.tracePath({c:cPath},kill=True,delay=3000)
    # m.tracePath({d:dPath},kill=True,delay=3000)
    # m.tracePath({e:m.path},delay=3000)

    m.tracePath({a:aPath,b:m.path,d:dPath},delay=600,kill=True)
